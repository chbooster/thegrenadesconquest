...
#$(eval $(call AKS2C,assets/music.aks,pre_music,src/,0x0200))
$(eval $(call AKS2C,assets/presentation.aks,pre_music_presentation,src/,0x0200))
$(eval $(call AKS2C,assets/battle.aks,pre_music_battle,src/,0x05AF))
#$(eval $(call AKS2C,assets/fx_instruments.aks,pre_fx_instruments,src/,0x0080))
